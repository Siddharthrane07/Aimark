...
interface ProjectState {
  ...
  createProject: (data: Partial<Project>) => Promise<{ error: any }>;
...
export const useProjectStore = create<ProjectState>((set, get) => ({
  ...
  createProject: async (data) => {
    set({ loading: true, error: null });
    console.log('[Store] Starting project creation with data:', data);
    ...
    try {
      ...
      console.log('[Store] Project creation result:', {
        success: !error,
        error: error?.message,
      ...
      console.error('[Store] Project creation error:', error);
      set({ error: error.message });
      return { error };
    } finally {
      set({ loading: false });
